...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        primary: '#FFD700',        // Brand Yellow (utama)
        'primary-dark': '#E6B800', // Hover Yellow

        secondary: '#444444',      // Dark Gray (branding accent, CTA bg)

        'gray-100': '#EAEAEA',     // Light Gray (background subtle)
        'gray-500': '#666666',     // Medium Gray (secondary text)
        'gray-900': '#1A1A1A',     // Almost Black (footer, strong bg)
